...
class FP4_server 
{
	private Socket socket = null; private ServerSocket server = null; private DataInputStream in = null;
	private DataOutputStream out = null;
	public FP4_server(int port) 
	{ String id = "";
	int i = 0;
	try
	{
	...
	{ FP4_server server = new FP4_server(5000);
	}
}
